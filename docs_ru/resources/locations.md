...
address | [Location.Address](#address) | Контакты Возовоз в населенном пункте: `phoneNumber` - телефонный номер
contacts | object | Контакты Возовоз в населенном пункте: `phoneNumber` - телефонный номер

#### Объект <a name="address">`Order.Address`</a>
...
#### Объект <a name="terminal">`Order.Terminal`</a>
